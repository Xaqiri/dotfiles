;;; Copied from doom-tokyo-night and modified to match tokyo-night.nvim
...
(def-doom-theme xaqiri
  "A modified version of the doom tokyo night theme"
  ...
  ((bg         '("#24283b" nil       nil            ))
   ...
   ;; (teal       '("#1abc9c" "#2ac3de" "brightgreen"  ))
   ...
   (violet     '("#9d7cd8" "#9aa5ce" "brightmagenta"))
   (cyan       '("#7dcfff" "#b4f9f8" "brightcyan"   ))
   (dark-cyan  '("#7dcfff" "#7dcfff" "cyan"         ))
   ; Additional custom colors
   (dark-green '("#9ece6a" "#9ece6a" "green"        ))
   (brown      '("#cfc9c2" "#cfc9c2" "yellow"       ))
   (green1     '("#73daca" "#73daca" "green1"       ))
   (green2     '("#41a6b5" "#41a6b5" "green2"       ))
  ...
  (
   ...
   (markdown-header-face-1 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.6 :foreground red)
   (markdown-header-face-2 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.5 :foreground dark-green)
   (markdown-header-face-3 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.4 :foreground yellow)
   (markdown-header-face-4 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.3 :foreground blue)
   (markdown-header-face-5 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.2 :foreground magenta)
   (markdown-header-face-6 :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic :height 1.1 :foreground cyan)
   (markdown-list-face :foreground cyan)
   (markdown-header-delimiter-face :foreground base5)
   (markdown-italic-face :foreground cyan)
   (markdown-bold-face :foreground cyan)
   (markdown-line-break-face :foreground blue :underline t)
   (markdown-blockquote-face :foreground magenta)
   ...
   (org-level-1 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.6 :foreground red)
   (org-level-2 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.5 :foreground yellow)
   (org-level-3 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.4 :foreground dark-green)
   (org-level-4 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.3 :foreground cyan)
   (org-level-5 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.2 :foreground blue)
   (org-level-6 :font "VictorMono Nerd Font" :weight 'regular :slant 'italic :height 1.1 :foreground magenta)
   (italic :foreground cyan)
   (bold :foreground cyan)
 

   ;; prog-mode
   (font-lock-type-face :foreground green2)
   ;; (font-lock-variable-name-face :foreground yellow)
   ;; (font-lock-variable-use-face :foreground fg)
   (font-lock-function-name-face :font "VictorMono Nerd Font" :foreground blue :weight 'semi-bold :slant 'italic)
   (font-lock-comment-face :foreground base5 :font "VictorMono Nerd Font" :weight 'normal :slant 'italic)
   (font-lock-property-use-face :foreground green)
   (font-lock-property-name-face :foreground green)
   (font-lock-preprocessor-face :foreground (doom-lighten magenta 0.25) :weight 'regular)
   (font-lock-keyword-face :foreground violet :font "VictorMono Nerd Font" :weight 'semi-bold :slant 'italic)
